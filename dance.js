...
class snakeSegment{
	...
	render()
	{
		...
		console.log("rotY = ", Math.atan2(this.dir.z, this.dir.x ));
		console.log("rotX = ", Math.acos(-this.dir.y / this.dir.mag()));
		if(this.dir.x != 0 || this.dir.z != 0) rotateY( Math.atan2(this.dir.z, this.dir.x) );
