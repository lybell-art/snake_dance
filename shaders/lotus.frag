...
//	vec2 uv = gl_FragCoord.xy/uResolution;
	...
	float ampApply = map(ampLevel,0.0,1.0,0.7,1.3);
	...
	vec4 col4 = mandala4(dist*ampLevel, angle, uTime, vec4(1.0,0.4,0.8,1.0));
	vec4 col5 = mandala5(dist*ampLevel, angle, uTime, vec4(1.0,0.7,0.2,1.0));
